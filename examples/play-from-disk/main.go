...
func main() {
	...
	if haveVideoFile {
		...
		if _, videoTrackErr = peerConnection.AddTransceiverFromTrack(videoTrack); videoTrackErr != nil {
			panic(videoTrackErr)
		}
	...
	if haveAudioFile {
		...
		if _, audioTrackErr = peerConnection.AddTransceiverFromTrack(audioTrack); audioTrackErr != nil {
			panic(audioTrackErr)
		}
