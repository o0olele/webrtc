...
func main() {
	...
	if _, err = peerConnection.AddTransceiverFromTrack(outputTracks["q"]); err != nil {
		panic(err)
	}
	if _, err = peerConnection.AddTransceiverFromTrack(outputTracks["h"]); err != nil {
		panic(err)
	}
	if _, err = peerConnection.AddTransceiverFromTrack(outputTracks["f"]); err != nil {
		panic(err)
	}
