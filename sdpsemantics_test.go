...
func TestSDPSemantics_PlanBAnswerSenders(t *testing.T) {
	...
	if _, err = apc.AddTransceiverFromTrack(video1); err != nil {
	...
	if _, err = apc.AddTransceiverFromTrack(video2); err != nil {
		t.Errorf("Failed to add video track")
	}
	...
	if _, err = apc.AddTransceiverFromTrack(audio1); err != nil {
	...
	if _, err = apc.AddTransceiverFromTrack(audio2); err != nil {
		t.Errorf("Failed to add audio track")
	}
